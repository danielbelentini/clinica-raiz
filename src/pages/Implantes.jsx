  ...
  return (
    <section aria-label="Página de implantes" className="py-24 px-6 text-center" style={{ background: '#EEF1F7', paddingTop: '7rem' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <a href="https://wa.me/5511999921543" target="_blank" rel="noopener noreferrer" className="btn-primary">
...
const tratamentos = [
  ...
  },
  {
    ...
    tag: 'No mesmo dia',
    img: 'url(https://images.unsplash.com/photo-1620775997990-ee3c25938b4c?w=800&q=80&auto=format&fit=crop)',
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="flex flex-col gap-4 mb-8">
            {[
              { label: 'Endereço', val: 'Rua Wisard, 85 — Pinheiros, São Paulo' },
              { label: 'Horários', val: 'Seg a Sex: 08h às 19h · Sáb: 08h às 14h' },
              { label: 'WhatsApp', val: '(11) 99992-1543' },
            ].map((i) => (
          ...
          <a href="https://wa.me/5511999921543" target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center gap-2 w-fit">
        ...
        <div className="rounded-xl overflow-hidden" style={{ height: '320px', border: '1px solid #e2e8f0' }}>
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d768.881529536529!2d-46.68897131144061!3d-23.55272411631434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce579652007787%3A0x416ea516e1f144d8!2sR.%20Wisard%2C%2085%20-%20Vila%20Madalena%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2005434-000!5e0!3m2!1spt-BR!2sbr!4v1777906075733!5m2!1spt-BR!2sbr"
          />
        </div>
      </div>
    </section>
